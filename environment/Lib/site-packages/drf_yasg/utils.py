...
def swagger_auto_schema(method=None, methods=None, auto_schema=unset, request_body=None, query_serializer=None,
                        manual_parameters=None, operation_id=None, operation_summary=None,
    ...
    The `auto_schema` and `operation_summary` arguments take precedence over view- or method-level values.
    ...
    :param str operation_summary: operation description override
